...
This image includes the basic libraries for running some workflows on the [vdaas/vald-ci-labs](https://github.com/vdaas/vald-ci-labs) repository.

<div align="center">
    <img src="https://github.com/vdaas/vald-ci-labs/blob/main/assets/image/readme.svg?raw=true" width="50%" />
</div>

[![latest Image](https://img.shields.io/docker/v/vdaas/vald-ci-labs-ci-container/latest?label=vald-ci-container)](https://hub.docker.com/r/vdaas/vald-ci-labs-ci-container/tags?page=1&name=latest)
...
jobs:
  {job_titile}:
    ...
    container:
      image: ghcr.io/vdaas/vald-ci-labs/vald-ci-container:latest
    steps:
      - name: {step_name}
    ...
```

The sample workflows are [here](https://github.com/vdaas/vald-ci-labs/search?l=YAML&q=vald-ci-container).
...
The `Dockerfile` of this image is [here](https://github.com/vdaas/vald-ci-labs/blob/main/dockers/ci/base/Dockerfile).
