...
[![latest Image](https://img.shields.io/docker/v/vdaas/vald-ci-labs-dev-container/latest?label=vald-dev-container)](https://hub.docker.com/r/vdaas/vald-ci-labs-dev-container/tags?page=1&name=nightly)
...
Please use this container with [our Dev Container settings](https://github.com/vdaas/vald-ci-labs/blob/main/.devcontainer/devcontainer.json).
...
The `Dockerfile` of this image is [here](https://github.com/vdaas/vald-ci-labs/blob/main/dockers/dev/Dockerfile).
