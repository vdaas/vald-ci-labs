...
[![latest Image](https://img.shields.io/docker/v/vdaas/vald-ci-labs-filter-gateway/latest?label=vald-filter-gateway)](https://hub.docker.com/r/vdaas/vald-ci-labs-filter-gateway/tags?page=1&name=latest)
...
The `Dockerfile` of this image is [here](https://github.com/vdaas/vald-ci-labs/blob/main/dockers/gateway/filter/Dockerfile).
