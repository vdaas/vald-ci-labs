...
Please use [internal/errgroup](https://github.com/vdaas/vald-ci-labs/blob/main/internal/errgroup) for synchronized error handling on multi-goroutine processing.
