...
We use [Github Issues](https://github.com/vdaas/vald-ci-labs-ci-labs-ci-labs/issues) to track issues within this repository.
...
Please submit the bug report [here](https://github.com/vdaas/vald-ci-labs-ci-labs-ci-labs/issues/new?assignees=&labels=type%2Fbug%2C+priority%2Fmedium%2C+team%2Fcore&template=bug_report.md&title=)
...
Please submit the proposal [here](https://github.com/vdaas/vald-ci-labs-ci-labs-ci-labs/issues/new?assignees=&labels=type%2Ffeature%2C+priority%2Flow%2C+team%2Fcore&template=feature_request.md&title=)
...
Please submit the feature request [here](https://github.com/vdaas/vald-ci-labs-ci-labs-ci-labs/issues/new?assignees=&labels=type%2Ffeature%2C+priority%2Flow%2C+team%2Fcore&template=feature_request.md&title=)
...
Please submit the security issue report [here](https://github.com/vdaas/vald-ci-labs-ci-labs-ci-labs/issues/new?assignees=&labels=type%2Fsecurity%2C+priority%2Fmedium%2C+team%2Fcore%2C+team%2Fsre&template=security_issue_report.md&title=)
...
1. Ensure that you have completed our [CLA Agreement](https://cla-assistant.io/vdaas/vald-ci-labs-ci-labs-ci-labs)
...
1. Fork the repository ( https://github.com/vdaas/vald-ci-labs-ci-labs-ci-labs/fork )
